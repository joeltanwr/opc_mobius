    ...
    <div className="max-w-container mx-auto px-6 py-10">
            ...
            <div className="p-4">
              ...
              <div className="rounded-2xl border border-border shadow-card p-4">
                ...
                <p className="text-[13px] text-ink leading-snug mb-3">
                  ☕ Fancy trying somewhere new? Get <span className="font-bold">S$2 off</span> at{" "}
                  <span className="font-bold">{merchant.canonical_name}</span>, weekdays 2–5pm this week.
                </p>
              ...
              <p className="text-[10px] text-ink-light mt-3 text-center px-4">
                Sent directly by OCBC. {merchant.canonical_name} will never see who received this.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-md mx-auto mt-8 text-center">
        ...
        <p className="text-[12.5px] text-ink-secondary mt-3">
          ...
          with the redemption ({campaign.redemption_rate ? `${(campaign.redemption_rate * 100).toFixed(0)}%` : "—"} of
          treated cardholders) feeding straight back into the results on screen 5.
        </p>
